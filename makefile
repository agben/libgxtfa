...
$(objdir)/libgxtfa.a: $(objdir)/fa_handler.o $(objdir)/fa_sql_generator.o \
	 $(objdir)/fa_sql_generator_key.o $(objdir)/fa_sql_handler.o 
	ar rs $(objdir)/libgxtfa.a $(objdir)/fa_handler.o \
	 $(objdir)/fa_sql_generator.o $(objdir)/fa_sql_generator_key.o $(objdir)/fa_sql_handler.o \
...
$(objdir)/fa_handler.o: fa_handler.c $(includedir)/fa_def.h $(includedir)/fa_lun.h \
	...
	$(GCC) $(CFLAGS) -c $< -o $@
$(objdir)/fa_sql_generator.o: fa_sql_generator.c $(includedir)/fa_def.h \
	 $(includedir)/fa_sql_def.h $(objdir)/libgxtfa.a $(includedir)/ut_error.h \
